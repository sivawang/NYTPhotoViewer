...
- (void)updateProgressForPhoto:(id <NYTPhoto>)photo {
    [self.notificationCenter postNotificationName:NYTPhotoViewControllerPhotoProgressUpdatedNotification object:photo];
}
